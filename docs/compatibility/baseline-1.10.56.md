...
This is the recorded baseline for the Mason Markdown compatibility upgrade. The
...
- The `mason-v1` profile follows GFM soft-break behavior; the `legacy` profile
...
- The historical artifact was `build/libs/plugin-bytemd-1.10.56.jar`; its SHA-256 is
