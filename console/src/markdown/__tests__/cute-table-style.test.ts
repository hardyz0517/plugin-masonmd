...
const stylePath = join(__dirname, "../../styles/luogu-markdown.scss");
...
describe("Cute Table style contract", () => {
  it("keeps a direct Three table intrinsic-width and centered after GitHub CSS", () => {
    const window = createDocument(`
      <table class="luogu-markdown-table luogu-cute-table-three">
  ...
  it("renders Tuack column and row rules from the table semantic class", () => {
    const window = createDocument(`
      <div class="luogu-table-scroll luogu-cute-table luogu-cute-table-tuack">
        <table class="luogu-markdown-table luogu-cute-table-tuack">
          <colgroup><col><col class="luogu-tuack-break"><col></colgroup>
  ...
  it("keeps epigraphs right-aligned and overrides GitHub blockquote defaults", () => {
    const window = createDocument(`
      <blockquote class="luogu-epigraph">
        <div class="luogu-epigraph-body"><p>Quote</p></div>
        <cite>-- author</cite>
      </blockquote>
    `);
    const epigraph = window.document.querySelector("blockquote");
    const body = window.document.querySelector(".luogu-epigraph-body");
